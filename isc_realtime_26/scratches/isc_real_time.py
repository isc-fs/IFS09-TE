        ...
        while True:
            ...
            while nrf.data_ready():
                ...
                if len(payload) == 32:
                     ...
                     print(f'ID: {hex(int(values[0]))}, 1: {round(values[1],2)}, 2: {round(values[2],2)}, 3: {round(values[3],2)}, 4: {round(values[4],2)}, 5: {round(values[5],2)}, 6: {round(values[6],2)}, 7: {values[7]}')
